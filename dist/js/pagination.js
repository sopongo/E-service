(function (global, factory) {
    ...
    var Pagination = /** @class */ (function () {
        ...
        Pagination.prototype.make = function (itemsCount, itemsOnPage, defaultPageNumber) {
            ...
            //this.paginationContainer.append("test");
        ...
        Pagination.prototype.createPageList = function () {
            ...
            paginationUl.classList.add("float-left");
        ...
        Pagination.prototype.createPageElement = function (label, pageNumber) {
            ...
            pageLink.setAttribute("data-page-number", pageNumber); //คลาสโค๊ดเดิมคือ data-page-number
        ...
        Pagination.prototype.createPageInput = function () {
            ...
            inputGroupDiv.classList.add("float-right");
            //inputGroupDiv.append("ไปที่หน้า:");

            /*$(inputGroupDiv).append("<select>");
                for (var xxxx = 1; xxxx <= (this).pageCount; xxxx++) {
					$(inputGroupDiv).append("<option data-page-number=\"2\" value=\""+(this).pageCount+"\">"+(this).pageCount+"</option>");
                }
            $(inputGroupDiv).append("</select>");
			*/
            ...
            goToPageInput.classList.add("form-control","rounded", "numonly", "ml-1", "goto-num");
            goToPageInput.addEventListener("keydown", (this.onGoToInputKeyPress.bind(this)));
            goToPageButton.setAttribute("type", "button");
            goToPageButton.classList.add("btn", "btn-sm", "page-togo", "btn-success");

            goToPageButton.classList.add("page-togo");
