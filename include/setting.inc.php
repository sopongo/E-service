...
$arrSurvey = array( 
    array(0,'ระยะเวลาทำงาน'),
    array(1,'ความสะอาด เศษโลหะ, เศษวัสดุ, ฝุ่น'),
    array(2,'ความแข็งแรง สวยงาม'),
    array(3,'วัสดุซ่อมได้มาตรฐาน'),
    array(4,'ไม่ก่อให้เกิดความเสียหายต่อส่วนอื่นๆ'),
    array(5,'ทดสอบเครื่องจักร'),
    array(6,'เสร็จสมบูรณ์ ไม่ต้องต่อเติมภายหลัง'),
    array(7,'สอดคล้องระเบียบบริษัท และลูกค้า'),
);
