...
class PHPMailer {
   ...
   * @var string
   */
  public $From = 'หฟกฟหกดหกฟด';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'asdfasdfaฟหกดฟหกดsdfasdfasdf';
  ...
  */
   ...
   * @var string
   */
  //public $Host          = 'mail.leeandsteel.co.th';
  public $Host          = 'mail.nongphojsin.com';  
   ...
   * @var string
   */
  //public $Username      = 'noreply@leeandsteel.co.th';
  public $Username      = '$email_system';  

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = '$pws_email';
