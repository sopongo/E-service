...
--
-- Host: localhost:3306
-- Generation Time: Mar 21, 2023 at 11:11 AM
...
(97, NULL, 1, NULL, NULL, NULL, 7, 'ไม่มีหมวด', NULL, '2023-03-21 17:36:33', 176, NULL, NULL, 1);
...
(1, 'MT-AS-0001', 7, 97, NULL, NULL, 'ไม่ทราบชื่อเครื่องจักร-อุปกรณ์', 'ใช้แจ้งซ่อมสำหรับเครื่องจักร-อุปกรณ์ ที่ไม่ทราบข้อมูล', '2023-03-21 18:08:01', 176, NULL, NULL, 1);
...
(3, '6501278', 'bfe277ea3e2275a6809a0e8f7b3a3baa601664fa', 'sopon.g@jwdcoldchain.com', NULL, 'Sopon G.', 1, NULL, NULL, 4, 99, 13, 1, 1, '2023-02-02 06:48:06', 1, NULL, NULL, NULL, NULL),
...
(178, '', 'bfe277ea3e2275a6809a0e8f7b3a3baa601664fa', 'usertest1@pcs-plp.com', NULL, '', NULL, NULL, NULL, 1, 1, 5, NULL, 1, '2023-03-21 17:01:51', 3, NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `tb_machine_master`
  MODIFY `id_machine` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tb_site_responsibility`
  MODIFY `id_site_responsibility` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `tb_user`
  MODIFY `id_user` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=179;
