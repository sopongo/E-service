...
<link rel="stylesheet" href="plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">                            
            ...
            <?PHP
                ...
                $rowMechanic = $obj->fetchRows("SELECT id_user, fullname FROM tb_user WHERE ref_id_site=".$_SESSION['sess_ref_id_site']." AND  ref_id_dept=".$_POST['ref_id_dept_responsibility']." AND (class_user=2 OR class_user=3 OR class_user=4) ORDER BY fullname ASC");
                if (count($rowMechanic)!=0) {
                    foreach($rowMechanic as $key => $value) {
