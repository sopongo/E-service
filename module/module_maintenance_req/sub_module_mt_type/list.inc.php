...
.dropdown-menu a.dropdown-item{  font-size:0.85rem; /* 40px/16=2.5em */ }
    ...
    <?php
      include_once 'module/module_maintenance_req/sub_module_mt_type/frm_add-edit.inc.php'; //หน้า add/edit
    ?>
  ...
  $('#some_button').click(function refreshData() {
    ...
    $('#example1').DataTable({
      ...
      ajax: {
        ...
        url: 'module/module_maintenance_req/sub_module_mt_type/datatable_processing.php',
        type: 'POST',
...
$(document).ready(function () {
  ...
  $('#example1_length').append('<div class="col-10 d-inline"><button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-default" id="addData" data-backdrop="static" data-keyboard="false"><i class="fas fa-plus-circle"></i> เพิ่มชื่อประเภทใบแจ้งซ่อม</button></div>');
  $('input[type=search]').attr('placeholder', 'ชื่อประเภทใบแจ้งซ่อม');
  ...
  $(document).on('click','#addData',function(){  
    $("#id_row").val('');
    $('#exampleModalLabel span').html("เพิ่มชื่อประเภทใบแจ้งซ่อม");
  });
