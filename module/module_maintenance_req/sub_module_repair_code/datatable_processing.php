...
$query_search = "";
if(!empty($search[0])){
    $query_search = " WHERE (repair_code_name LIKE '%".$search."%') AND tb_repair_code.ref_id_dept=".$_SESSION['sess_id_dept']." ";
}else{
    $query_search = " WHERE tb_repair_code.ref_id_dept=".$_SESSION['sess_id_dept']." ";
}
