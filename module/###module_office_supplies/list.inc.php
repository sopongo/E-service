...
$(document).on("click", ".btn-adj-balance", function (e){
  e.preventDefault();
    ...
    <section class="content">
      ...
      <?php
      include_once 'module/module_office_supplies/frm_add-edit.inc.php'; //หน้า add/edit
      //include_once 'module/module_office_supplies/view.inc.php'; //หน้าดูรายละเอียดราย ID
      include_once 'module/module_office_supplies/frm_rcv-cut.inc.php'; //หน้า add/edit
      ?>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title font-weight-bold" id="exampleModalLabel"><i class="fas fa-user"></i> รับเข้าวัสดุ-อุปกรณ์</h5>
      ...
      <div class="pt-3 pb-3 card-title">
...
function func_getDatalist() {
  ...
  $.ajax({
    url: "module/module_office_supplies/ajax_action.php",
    type: "GET",
    dataType: "json",    
