...
/*echo "INSERT INTO `tb_building` (`id_building`, `ref_id_site`, `building_initialname`, `building_name`, `building_status`) VALUES";
for($i=14;$i<=900;$i++){
    echo "<br/>(NULL, '".(rand(1, 6))."', 'B.".$i."', 'อาคาร ".$i."', '".(rand(1, 2))."'),";
}
 */

/*echo " INSERT INTO `tb_location` (`id_location`, `ref_id_site`, `ref_id_building`, `location_initialname`, `location_name`, `location_status`) VALUES";
for($i=1;$i<=10;$i++){
    echo "<br/>(NULL, 0, 0, 0, 'PCS ดาดฟ้าอาคาร 1', 1),";
}
*/
?>
...
<section class="content">
    ...
    <h6 class="display-8 d-inline-block font-weight-bold"><i class="fas fa-map-marker-alt"></i> <?PHP echo $title_act;?></h6>
    ...
    <?php
      include_once 'module/module_location/frm_add-edit.inc.php'; //หน้า add/edit
    ?>
  ...
  $('#some_button').click(function refreshData() {
    ...
    $('#example1').DataTable({
      ...
      "aoColumnDefs": [
        ...
        { "bSearchable": false, "aTargets": [0, 4, 5, 6] } //คอลัมน์ที่าจะไม่ให้เสริท
      ], 
      ajax: {
        beforeSend: function () {
          //จะให้ทำอะไรก่อนส่งค่าไปหรือไม่
        },
        url: 'module/module_location/datatable_processing.php',
        type: 'POST',
...
$(document).ready(function () {
  ...
  $('#example1_length').append('<div class="col-10 d-inline"><button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-default" id="addData" data-backdrop="static" data-keyboard="false"><i class="fas fa-plus-circle"></i> เพิ่มสถานที่ใช้งาน</button></div>');
  ...
  $(document).on('click','#addData',function(){   
    $('#exampleModalLabel span').html("เพิ่มสถานที่ใช้งาน");
  });

  
  $(document).on('click','.edit-data',function(){   
    $('#exampleModalLabel span').html("แก้ไขสถานที่ใช้งาน");
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if(data){//tb_id_location   id_location, ref_id_site, ref_id_building, location_initialname, location_name, location_status
          ...
          $('#exampleModalLabel span').html("แก้ไขสถานที่ใช้งาน: "+data.location_name);
  ...
  $(document).on('click','.check-status',function(){
    ...
    /*module/module_location/datatable_processing.php*/
</script>