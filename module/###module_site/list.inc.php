...
<?PHP
$obj = new CRUD();
$numRow_player = $obj->getCount("SELECT count(id_location) AS total_row FROM tb_location");
...
?>    
    ...
    <section class="content">
        ...
        <div class="card-header">
          ...
          <div class="card-tools">
            <ol class="breadcrumb float-sm-right pt-1 pb-1 m-0">
              ...
              <li class="breadcrumb-item active">ไซต์งาน</li>
            </ol>
          </div><!-- /.col -->
        </div>
      ...
      <?php include_once 'module/module_site/frm_add-edit.inc.php'; //หน้า add/edit?>
      ...
      <div class="col-10">
        ...
        <i class="fas fa-circle"></i> เพิ่มไซต์งาน</button>
      </div>
      <div class="col-2">
        ...
        <span>จาก: <span id="totalpages"></span> หน้า</span>
            ...
            <colgroup>
              ...
              <thead class="thead-light">                
                <tr>
                  <th scope="col">#</th>
                  <th scope="col">ชื่อย่อไซต์งาน</th>
...
function getplayerrow(row) {
  ...
  if (row) {
     dataRow = `<tr>
          ...
          <a href="#" class="btn-sm pt-1 pb-2 btn-success mr-3 profile" data-toggle="modal" data-target="#userViewModal" title="Prfile" data-id="${row.id_location}">ดูข้อมูล</a>
          <a href="#" class="btn-sm pt-1 pb-2 btn-warning mr-3 editdata" data-toggle="modal" data-target="#userModal" title="Edit" data-id="${row.id_location}">แก้ไข</a>
          <a href="#" class="btn-sm pt-1 pb-2 btn-danger deleterow" data-id_menu="14" title="Delete" data-id="${row.id_location}">ลบ</a>
          </td>
        </tr>`;
  }
  return dataRow;
