...
<div class="modal-dialog modal-lg">
    ...
    <div class="modal-header">
        <h5 class="modal-title font-weight-bold" id="exampleModalLabel"><i class="fas fa-angle-double-right"></i> <span>เพิ่มไซต์งาน</span></h5>
                    ...
                    <div class="card-body p-3"> 
                        ...
                        <div class="col-sm-12 col-md-12 col-xs-12">  
                            <div class="form-group mb-2">
                                ...
                                <div class="form-check-inline"><div class="custom-control custom-radio"><input type="radio" class="custom-control-input" id="status_use" name="site_status" value="1" aria-describedby="inputGroupPrepend" required><label class="custom-control-label text-success" for="status_use">ใช้งาน</label></div></div>
                                <div class="form-check-inline"><div class="custom-control custom-radio"><input type="radio" class="custom-control-input" id="status_hold" name="site_status" value="2" aria-describedby="inputGroupPrepend" required><label class="custom-control-label text-danger w-auto d-inline" for="status_hold">ระงับใช้งาน</label><div class="invalid-feedback float-right w-auto pl-3">เลือกสถานะการใช้งาน</div></div></div>
                            </div>
                        </div>  
                        </div><!--row-1-->
                        ...
                        <div class="row row-4">
                            <div class="col-sm-6 col-md-6 col-xs-6">  
                                <div class="form-group">  
                                    <label for="firstname">ชื่อย่อไซต์งาน <span class="text-red font-size-sm">(**ต้องไม่ซ้ำกับที่มีในระบบ)</span></label>  
                                    <input type="text" id="site_initialname" name="site_initialname" maxlength="6" placeholder="ชื่อย่อไซต์งาน" class="form-control" aria-describedby="inputGroupPrepend" required />
                            ...
                            <div class="col-sm-6 col-md-6 col-xs-6">  
                                <div class="form-group">  
                                    ...
                                    <input type="text" id="site_name" name="site_name" placeholder="ชื่อไซต์งาน" class="form-control" aria-describedby="inputGroupPrepend" required />
...
/*ปุ่ม ADD Recive รับวัสดุเข้าระบบ <<<<<<<<<< เขียนใหม่ใช้โค๊ดนี้ สมบรูณ์กว่าไม่มีบั๊ครีเฟรชหน้าจอ*/
    ...
    if(formAdd.checkValidity()===false) {  
        ...
        $.ajax({
            url: "module/module_site/ajax_action.php",
            type: "POST",
