...
--
-- Host: localhost:3306
-- Generation Time: Feb 28, 2023 at 02:38 AM
...
(1, 'MT-FM-IT-2302-0001', 7, 1, 13, '2023-02-21 14:01:17', 118, 21, 7, 1, 3, NULL, '2023-02-22 14:27:24', NULL, NULL, 'ทดสอบแจ้งซ่อม', 1, 1, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'ทดสอบระบบ', '2023-02-23 15:55:53', 113, 2),
(2, 'MT-FM-MT-2302-0001', 7, 1, 7, '2023-02-21 14:11:58', 118, 18, 5, 1, 3, NULL, '2023-02-27 15:53:19', NULL, NULL, ' test test test test test test', 1, 1, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(3, 'MT-FM-IT-2302-0002', 7, 1, 13, '2023-02-27 11:09:01', 113, 24, 0, 0, 0, NULL, NULL, NULL, NULL, ' test test test test test test', 1, 1, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1);
...
CREATE TABLE `tb_ref_repairer` (
  ...
  `time` int NOT NULL COMMENT 'ลำดับครั้งที่เพิ่ม/เปลี่ยนช่าง'
...
INSERT INTO `tb_ref_repairer` (`id_ref_repairer`, `ref_id_maintenance_request`, `ref_id_user_repairer`, `acknowledge_date`, `time`) VALUES
(1, 1, 114, NULL, 0),
(2, 1, 115, NULL, 0),
(3, 1, 126, NULL, 0),
(4, 2, 116, NULL, 1),
...
--
ALTER TABLE `tb_maintenance_request`
  MODIFY `id_maintenance_request` int NOT NULL AUTO_INCREMENT COMMENT 'ID ใบแจ้งซ่อม', AUTO_INCREMENT=4;
