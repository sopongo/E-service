...
--
-- Host: localhost:3306
-- Generation Time: Feb 28, 2023 at 07:48 AM
...
(1, 'MT-FM-IT-2302-0001', 7, 1, 13, '2023-02-21 14:01:17', 118, 21, 7, 1, 3, NULL, '2023-02-22 14:27:24', NULL, 1, 'ทดสอบแจ้งซ่อม', 1, 1, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'ทดสอบระบบ', '2023-02-23 15:55:53', 113, 2),
(2, 'MT-FM-MT-2302-0001', 7, 1, 7, '2023-02-21 14:11:58', 118, 18, 5, 1, 3, NULL, '2023-02-27 15:53:19', NULL, 2, ' test test test test test test', 1, 1, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(3, 'MT-FM-IT-2302-0002', 7, 1, 13, '2023-02-27 11:09:01', 113, 24, 0, 0, 0, NULL, NULL, NULL, 1, ' test test test test test test', 1, 1, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
...
(5, 'IT-FM-MT-2302-0002', 13, 1, 7, '2023-02-28 11:52:52', 3, 27, 0, 0, 0, NULL, NULL, NULL, 1, 'ก๊อกน้ำปิดไม่สนิท มีน้ำหยดตลอดเวลา', 1, 2, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1);
...
--
ALTER TABLE `tb_category`
  MODIFY `id_menu` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=96;
...
--
ALTER TABLE `tb_machine_master`
  MODIFY `id_machine` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `tb_maintenance_request`
  MODIFY `id_maintenance_request` int NOT NULL AUTO_INCREMENT COMMENT 'ID ใบแจ้งซ่อม', AUTO_INCREMENT=6;
...
--
ALTER TABLE `tb_ref_repairer`
  MODIFY `id_ref_repairer` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
