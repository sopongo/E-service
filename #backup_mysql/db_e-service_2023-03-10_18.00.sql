...
--
-- Host: localhost:3306
-- Generation Time: Mar 10, 2023 at 11:00 AM
...
CREATE TABLE `tb_outsite_repair` (
  ...
  `ref_id_supplier` int DEFAULT NULL COMMENT 'REF.ซัพคอนแทค',
  `datesent_repair` datetime NOT NULL COMMENT 'วันที่ส่งซ่อม',
  `dateresive_repair` datetime DEFAULT NULL COMMENT 'วันที่ซ่อมเสร็จ',
  `ref_id_user_update` int NOT NULL COMMENT 'วันที่เพิ่มข้อมูล',
  `date_outsite_repair` datetime NOT NULL COMMENT 'REF.ไอดีuser'
...
(10, 21, '24', 'พิมพ์เอง EDIT', 'PSU เสีย พิมพ์เอง EDIT', 'ทำ PM ทุกเดือน พิมพ์เอง EDIT', 114, '2023-03-09 14:23:10', '2023-03-09 14:24:26', 114);
...
--
ALTER TABLE `tb_attachment`
  MODIFY `id_attachment` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
...
--
ALTER TABLE `tb_machine_site`
  MODIFY `id_machine_site` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `tb_maintenance_request`
--
ALTER TABLE `tb_maintenance_request`
  MODIFY `id_maintenance_request` int NOT NULL AUTO_INCREMENT COMMENT 'ID ใบแจ้งซ่อม', AUTO_INCREMENT=22;
