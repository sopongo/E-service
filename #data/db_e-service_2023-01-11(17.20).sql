...
--
-- Host: localhost:3306
-- Generation Time: Jan 11, 2023 at 10:23 AM
...
(14, 7, 'FC14', 'สิ่งแปลกปลอม', 'Foreign object', '', 1),
...
(27, 13, 'TEST-1', 'test-edit-1', 'test-edit-1', 'test-edit-1', 1);
...
(14, 'test-add-2-edit', 13, 'test-add-2-edit', 1),
(15, 'testxxx', 13, 'testxxx', 1);
...
(2, 13, 'ตกรุ่นหาอะไหล่ไม่ได้', 'ตกรุ่นหาอะไหล่ไม่ได้ **ใช้กับทุก Device', 2),
...
(5, 8, 'test-add-edit-999999', '1234567980', 'test-add-edit-999999', 1);
...
--
ALTER TABLE `tb_category`
  MODIFY `id_menu` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;
...
--
ALTER TABLE `tb_repair_code`
  MODIFY `id_repair_code` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
