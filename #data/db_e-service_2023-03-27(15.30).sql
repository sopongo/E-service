...
(6, 'PCS-FM-MT-2303-0006', 13, 1, 7, '2023-03-27 14:21:36', 126, 456, 0, 0, 0, NULL, NULL, NULL, NULL, 1, 'ทดสอบแจ้งซ่อม', 1, 1, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1);
...
--
ALTER TABLE `tb_attachment`
  MODIFY `id_attachment` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tb_maintenance_request`
  MODIFY `id_maintenance_request` int NOT NULL AUTO_INCREMENT COMMENT 'ID ใบแจ้งซ่อม', AUTO_INCREMENT=7;
...
--
ALTER TABLE `tb_site_responsibility`
  MODIFY `id_site_responsibility` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
